...
DreamTask 代表了 Agent 自主性的一个维度：系统自己决定什么时候做记忆整理。Swarm 多智能体协作则代表了另一个维度：多个 Agent 如何协调分工。第 29 章将从 Teammate 生命周期开始，展开 Swarm 架构的全景（详见第 29 章）。
