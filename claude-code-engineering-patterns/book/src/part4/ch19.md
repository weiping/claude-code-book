...
本章的记忆系统关注的是"如何把信息持久化到文件系统，跨会话注入到提示词"。下一章我们将目光移向会话内的另一套机制——Agent 的 Hooks 系统：27 个生命周期事件如何让外部代码在精确的时间点介入 Agent 的执行流程，详见第 20 章。
