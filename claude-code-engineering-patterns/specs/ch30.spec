spec: task
name: "第30章：leaderPermissionBridge——跨进程权限协商模式"
...
- 前置依赖：第29章（Swarm 架构，明确了 Leader 和 Teammate 的角色）
...
### 允许修改
- book/src/part7/ch30.md

### 禁止做
- 不修改 DESIGN.md 或其他章节文件
- 不重复第29章对 Swarm 架构总览的描述
- 不展开 permissionSync（第32章）
...
- permissionSync 多 Agent 权限同步（第32章）
