spec: task
name: "第29章：Teammate 生命周期——Swarm 架构总览"
...
- 前置依赖：第25章（Task 系统，InProcessTeammateTask 是 Swarm 的基础）
...
### 允许修改
- book/src/part7/ch29.md

### 禁止做
- 不修改 DESIGN.md 或其他章节文件
- 不展开 leaderPermissionBridge（第30章）
- 不展开三种 Teammate 后端（第31章）
