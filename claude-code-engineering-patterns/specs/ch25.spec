spec: task
name: "第 25 章：四种执行器——command/prompt/agent/http 的多态设计"
...
### 允许修改
- book/src/part7/ch25.md

### 禁止做
- 不修改 DESIGN.md 或其他章节文件
- 不重复第 24 章对 HookEvent 全景的描述
- 不展开 AsyncHookRegistry 内部实现（第 26 章）
