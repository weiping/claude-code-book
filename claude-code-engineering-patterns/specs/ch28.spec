spec: task
name: "第 28 章：Frontmatter Hooks——Skill 与 Agent 的声明式钩子注册"
...
- 前置依赖：第 27 章（hooksConfigSnapshot，frontmatter hooks 也写入快照）、第 18 章（Skill 加载）
